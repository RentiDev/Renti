...
const Services = () => {
    ...
    const tenantClasses = "flex flex-col items-center h-[90vh] w-screen px-[5vw] bg-[#83ABE1]";
    const landlordClasses = "flex flex-col items-center h-[90vh] w-screen px-[5vw] bg-[#ADD8E6]";
